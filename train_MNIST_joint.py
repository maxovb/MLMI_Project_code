...
if __name__ == "__main__":
    ...
    for i,num_samples in enumerate(num_training_samples):
        ...
        l_sup = (60000 * (1-validation_split))/num_samples
        l_unsup = 1
