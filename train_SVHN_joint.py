...
if __name__ == "__main__":
    ...
    evaluate = False
    if load:
        epoch_start = 220 # which epoch to start from
    else:
        epoch_start = 0
    ...
    ratios[-1] = (73257 * percentage_unlabelled_set * (1 - validation_split)) / num_samples / R
