from accuracy_plots import  plot_accuracy, extract_accuracies_from_list_of_files, extract_accuracies_form_file_with_multiple_columns
...
acc_dir_plot = "figures/accuracies_first_results_for_presentation.svg"
