...
if __name__ == "__main__":
    ...
    # type of model
    model_name = "NP_UG" # one of ["CNP", "ConvCNP", "ConvCNPXL", "UnetCNP", "UnetCNP_restrained", "UNetCNP_GMM","UNetCNP_restrained_GMM"]
    ...
    if not(variational):
        ...
        experiment_dir_list = ["saved_models/" + data_name +  "/joint" + ("_cons/" if consistency_regularization else "/") + str(percentage_label) + "P/", model_name, "/"]
