        ...
        for n_restrict in [2,None]:
            ...
            for layer_id in range(0,num_layers_to_peturb):
                ...
                visualisation_dir = "saved_models/MNIST/" + model_name + ("_semantics" if semantics else "") \
                                    ...
                                    ("_restrict" + str(n_restrict) if n_restrict else "") + ".svg"
                ...
                show_label = False
                if layer_id == 4:
                    gen_title = "No blocking"
                    show_label = True
                elif layer_id == 3:
                    gen_title = "Blocking layer 4"
                else:
                    gen_title = "Blocking layers 4-" + str(layer_id + 1)

                qualitative_evaluation_images(model,valid_data,num_context_points,device,visualisation_dir,convolutional,semantic_blocks,show_label=show_label,n_restrict=n_restrict,gen_title=gen_title)
